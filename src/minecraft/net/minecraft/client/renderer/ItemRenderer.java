...
public class ItemRenderer {
   ...
   public void renderItemInFirstPerson(float partialTicks) {
      ...
      if(this.itemToRender != null) {
         ...
         } else if((itemToRender.getItem() instanceof ItemSword && fakeBlock) || (abstractclientplayer.getItemInUseCount() > 0)) {
            	...
            	if(Wrapper.getModuleManager().getModule("Animations").isEnabled()) {
                   ...
                   case "Geuxy":
                      ...
                      case "What":
                         ...
                         this.transformFirstPersonItem(f / 2, 0.0f);
                         GlStateManager.rotate(-f8 * 30, 0.6f, 0.8f, 1f);
                         GlStateManager.rotate(-f8 * 45.0F, 10.0F, 1, 0);
                         this.func_178103_d();
                         break;
                      case "Eumel":
                         float f9 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * 3.1));
                         GL11.glTranslated(-0.05D, 0.2D, 0.0D);
                         this.transformFirstPersonItem(f / 2, 0.0f);
                         GlStateManager.rotate(-f9 * 20, 0.1f, 0.5f, 0.8f);
                         GlStateManager.rotate(-f9 * 45.0F, 30.0F, 1, 0);
                         this.func_178103_d();
                         break;
            		}
            	} else {
