...
public class CsgoSlider extends Comp {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Gui.drawRect((int)(parent.posX + x - 20), (int)(parent.posY + y + 1) + scrollY, (int)(parent.posX + x - 20) + renderWidth, (int)(parent.posY + y + 20) + scrollY, ((Hud) Wrapper.getModuleManager().getModule("HUD")).getColor((long)y));
