		...
		if(e instanceof EventMove) {
            ...
            if (target != null) {
                if(!mc.gameSettings.keyBindBack.isKeyDown())
                    setSpeed((EventMove) e, getMoveSpeed(), RotationUtil.getRotations(target, 0, 0, false, false, false)[0], direction, (mc.thePlayer.getDistanceToEntity(target) <= range.getValue() - 1) ? 0.0 : 1.0);
