...
public class Animations extends Module {
	private final Setting mode = new Setting("Mode", this, "1.8", "1.7", "Basic", "Slide", "Rotate", "Astolfo", "Spin", "Exhibition", "Geuxy", "What");
	private final Setting swingSpeed = new Setting("Swing Speed", this, 6, 2, 50, true);
