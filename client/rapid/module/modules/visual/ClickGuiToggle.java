...
public class ClickGuiToggle extends Module {	
	...
	mode = new Setting("Mode", this, "Dropdown", "Normal"),
	theme = new Setting("Theme", this, "Rapid", "Nord", "Material"),
	outline = new Setting("Outline", this, true),
	categoryIcons = new Setting("Category Icons", this, true),
	background = new Setting("Background", this, true);
