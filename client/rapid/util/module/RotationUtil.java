...
public class RotationUtil extends MinecraftUtil {
    ...
    public static float[] getFixedRotations(EntityLivingBase entityIn, double shakeX, double shakeY) {
        return new float[] {
        updateRotation(mc.thePlayer.rotationYaw, RotationUtil.getRotations(entityIn, shakeX, shakeY)[0]),
        updateRotation(mc.thePlayer.rotationPitch, RotationUtil.getRotations(entityIn, shakeX, shakeY)[1])
        };
    }
