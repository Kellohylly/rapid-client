...
public class CFont {
	...
	protected boolean antiAlias, fractionalMetrics;
	...
	protected void drawQuad(float x, float y, float width, float height, float srcX, float srcY, float srcWidth, float srcHeight) {
		float renderSRCX = srcX / this.imgSize, renderSRCY = srcY / this.imgSize, renderSRCWidth = srcWidth / this.imgSize, renderSRCHeight = srcHeight / this.imgSize;
