    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                Gui.drawRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1, 0x30000000);
                Gui.drawRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, 0x40000000);

                Gui.drawRect(this.xPos, this.yPos + height + 1, this.xPos + this.width, this.yPos + this.height, isFocused() ? 0xFFFF4848 : -1);
            }
