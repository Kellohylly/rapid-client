...
public class Button extends Component {
	...
	public void renderComponent() {
		if(Wrapper.getSettingsManager().getSettingByName("Click Gui", "Outline").isEnabled())
			Gui.drawRect(parent.getX() - 1.5, this.parent.getY() + this.offset, parent.getX() + parent.getWidth() + 1.5, this.parent.getY() + 13.5 + this.offset, ((Hud)Wrapper.getModuleManager().getModule("HUD")).getColor(offset * 9L));
		...
		Gui.drawRect(parent.getX(), this.parent.getY() + this.offset, parent.getX() + parent.getWidth(), this.parent.getY() + 12 + this.offset, this.hovered ? (mod.isEnabled() ? new Color(ClickGui.hud.getColor(offset * 9L)).darker().getRGB() : 0xFF0D0E11) : (mod.isEnabled() ? ClickGui.hud.getColor(offset * 9L) : new Color(0xFF0F0F13).brighter().getRGB()));
		...
		if(this.open && !this.subcomponents.isEmpty()) {
			if(Wrapper.getSettingsManager().getSettingByName("Click Gui", "Outline").isEnabled())
				Gui.drawRect(parent.getX() - 1.5, parent.getY() + this.offset + 12, parent.getX() + 106.5, parent.getY() + this.offset + ((this.subcomponents.size() + 1) * 12) + 0.5, ClickGui.hud.getColor(offset * 9L));
			for(Component comp : this.subcomponents)
